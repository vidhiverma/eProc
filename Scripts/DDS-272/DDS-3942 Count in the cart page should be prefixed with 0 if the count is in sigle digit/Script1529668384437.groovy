...
if (b == 'false') {
    ...
    WebUI.waitForElementPresent(findTestObject('Cart Page/Cart Display For Count 1'), 5)

    WebUI.verifyElementText(findTestObject('Cart Page/Cart Display For Count 1'), 'Cart (01)')
} else {
    WebUI.click(findTestObject('Home'))
    ...
    WebUI.waitForElementVisible(findTestObject('Cart Page/Delete Icon_line item 1'), 5)

    WebUI.verifyElementPresent(findTestObject('Cart Page/Delete Icon_line item 1'), 5)
