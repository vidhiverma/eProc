...
WebUI.waitForElementClickable(findTestObject('Cart Page/Empty Cart Button'), 20)

WebUI.click(findTestObject('Cart Page/Empty Cart Button'))

WebUI.waitForElementPresent(findTestObject('Popups/Empty cart/Yes Button'), 5)

WebUI.click(findTestObject('Popups/Empty cart/Yes Button'))

WebUI.delay(3)

WebUI.verifyElementAttributeValue(findTestObject('Cart Page/Checkout Button'), 'ng-reflect-is-disabled', 'true', 3)

WebUI.verifyElementAttributeValue(findTestObject('Cart Page/Add Cart To Basket Button'), 'ng-reflect-is-disabled', 'true', 
    3)

WebUI.verifyElementAttributeValue(findTestObject('Cart Page/Empty Cart Button'), 'ng-reflect-is-disabled', 'true', 3)
