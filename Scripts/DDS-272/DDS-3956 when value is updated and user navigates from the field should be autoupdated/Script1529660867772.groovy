...
WebUI.waitForElementPresent(findTestObject('SearchResultPage/SearchItemTab/CatalogItems/Check Box For 3 Row Item List'), 30)
...
WebUI.click(findTestObject('Cart Page/Qty or Amt Edit Box for line item1'))

WebUI.sendKeys(findTestObject('Cart Page/Qty or Amt Edit Box for line item1'), Keys.chord(Keys.BACK_SPACE, '20'))

WebUI.click(findTestObject('Cart Page/Line Item Details/Quantity or Amt'))

WebUI.delay(2)

WebUI.verifyElementAttributeValue(findTestObject('Cart Page/Qty or Amt Edit Box for line item1'), 'ng-reflect-model', '20', 
    3)
