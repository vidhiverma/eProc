...
WebUI.waitForElementClickable(findTestObject('SearchResultPage/SearchItemTab/CatalogItems/Check Box For 3 Row Item List'), 10)
...
WebUI.verifyMatch(url, 'http://eproc-qa.zycus.net/#/online-store/cart', false)
