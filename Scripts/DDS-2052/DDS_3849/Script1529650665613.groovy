...
WebUI.verifyElementPresent(findTestObject('Popups/AddToBasket/Create New Radio Button'), 10)

WebUI.verifyElementPresent(findTestObject('Popups/AddToBasket/Existing Basket RadioButton'), 10)
