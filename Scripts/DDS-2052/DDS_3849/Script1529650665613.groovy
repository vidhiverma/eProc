...
WebUI.verifyElementPresent(findTestObject('Popups/AddToBasket/RadioButtonCreateNew'), 10)

WebUI.verifyElementPresent(findTestObject('Popups/AddToBasket/RadioButtonExistingBasket'), 10)
