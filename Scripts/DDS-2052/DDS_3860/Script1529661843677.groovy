...
WebUI.sendKeys(findTestObject('Popups/AddToBasket/BasketNameInputBox'), 'DeleteTestBasket')
...
WebUI.doubleClick(findTestObject('BasketsPage/BasketDetails/Basket Action button/Action Button'))

WebUI.doubleClick(findTestObject('BasketsPage/BasketDetails/Basket Action button/Delete'))

WebUI.doubleClick(findTestObject('Popups/DeleteBasket/YesButton'))
...
WebUI.verifyTextNotPresent('DeleteTestBasket', true)
