...
WebUI.verifyElementPresent(findTestObject('Popups/AddToBasket/RadioButtonCreateNew'), 5)

WebUI.verifyElementPresent(findTestObject('Popups/AddToBasket/RadioButtonExistingBasket'), 5)
