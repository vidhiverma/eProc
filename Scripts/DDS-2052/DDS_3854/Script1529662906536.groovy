...
WebUI.verifyElementPresent(findTestObject('Popups/AddToBasket/Create New Radio Button'), 5)

WebUI.verifyElementPresent(findTestObject('Popups/AddToBasket/Existing Basket RadioButton'), 5)
