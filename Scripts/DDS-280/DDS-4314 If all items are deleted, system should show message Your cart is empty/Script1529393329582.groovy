...
WebUI.waitForElementPresent(findTestObject('Cart Page/Cart Empty Message'), 5)

WebUI.verifyElementText(findTestObject('Cart Page/Cart Empty Message'), 'Your cart is empty ')
