...
WebUI.sendKeys(findTestObject('OnlineStorePage/Search Box'), findTestData('TestData').getValue(5, 4))
...
WebUI.verifyElementAttributeValue(findTestObject('SearchResultPage/SearchItemTab/CatalogItems/Out Of Stock Item'), 'ng-reflect-status', 
    'Out of Stock', 5)
