...
WebUI.click(findTestObject('SearchResultPage/SearchItemTab/CatalogItems/Catalog Item List Verification/Item3 For 3 Row'))

WebUI.delay(2)

WebUI.takeScreenshot('C:\\Screenshot/Item Description.png')
