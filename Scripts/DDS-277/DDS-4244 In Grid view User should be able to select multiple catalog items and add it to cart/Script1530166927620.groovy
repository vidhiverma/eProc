...
WebUI.click(findTestObject('SearchResultPage/SearchItemTab/CatalogItems/Grid view/Check Box 3 item'))
...
WebUI.verifyElementText(findTestObject('Cart Page/Verifying the Item list/Item3 Verification'), 'Item3')
