...
WebUI.waitForElementPresent(findTestObject('SearchResultPage/SearchItemTab/CatalogItems/Check Box For 2 row item list'), 
    50)
...
WebUI.click(findTestObject('OnlineStorePage/HeaderTab/FavoritesAndPreviouslyUsedTab/Verify ITEM1'))

WebUI.click(findTestObject('OnlineStorePage/HeaderTab/FavoritesAndPreviouslyUsedTab/Item Section/Specification Tab'))

WebUI.verifyElementText(findTestObject('OnlineStorePage/HeaderTab/FavoritesAndPreviouslyUsedTab/Item Section/Verify No Specification display'), 
