...
WebUI.click(findTestObject('OnlineStorePage/HeaderTab/FavoritesAndPreviouslyUsedTab/Item Section/Attachment Tab'))

WebUI.verifyElementText(findTestObject('OnlineStorePage/HeaderTab/FavoritesAndPreviouslyUsedTab/Item Section/Verify No Attachment Display'), 
