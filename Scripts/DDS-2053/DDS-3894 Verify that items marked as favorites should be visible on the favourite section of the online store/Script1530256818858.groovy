...
WebUI.waitForElementPresent(findTestObject('SearchResultPage/SearchItemTab/CatalogItems/Favorite Button For ITEM1'), 50)

WebUI.waitForElementPresent(findTestObject('SearchResultPage/SearchItemTab/CatalogItems/Favorite Button For Item3'), 50)
...
WebUI.waitForElementPresent(findTestObject('OnlineStorePage/HeaderTab/FavoritesAndPreviouslyUsedTab/Verify ITEM1'), 20)
